...
```vhdl
     ...
     | | | | | | | (__| | | (_) \  /\  |  __| |_) _\ | |   \ V / / __/ 
     |_| |_| |_|_|\___|_|  \___/ \/  \/ \___|_.__/\__|_|    \_/ |_____|  by JC`zic


```

#### :small_red_triangle_down: [Download last release (Zip)](https://github.com/jczic/MicroWebSrv/archive/master.zip)
